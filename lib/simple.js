...
const name = (withoutContact ? '' : v.name) || v.name || v.subject || v.vname || v.notify || v.verifiedName || load.name
...
isGroup: {
get() {
return isJidGroup(this.key.remoteJid) && this.key.remoteJid.endsWith(groupID);
},
enumerable: true,
},
chat: {
...
const sender = this.isGroup ? this.key.fromMe ? this.conn?.user?.jid : this.key?.participantAlt || this.key?.participantPn || this.key.participant || this.participant : this.chat
return sender
},
enumerable: true
},
